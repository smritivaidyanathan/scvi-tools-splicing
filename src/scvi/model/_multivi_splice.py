...
class MULTIVISPLICE(VAEMixin, UnsupervisedTrainingMixin, BaseModelClass, ArchesMixin):
    ...
    n_junctions
        The number of junction ratios (number of junctions). 
    modality_weights
    ...
    * The main batch annotation, specified in ``setup_anndata``, should correspond to
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self._model_summary_string = (
            ...
            f"n_junctions: {n_junctions}, n_proteins: {n_proteins}, n_hidden: {self.module.n_hidden}, "
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        #Added atse and junc counts to setup AnnData
        if atse_counts is not None:
            anndata_fields.append(LayerField("atse_counts_key", atse_counts, is_count_data=True))
